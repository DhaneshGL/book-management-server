    ...
    <Box sx={{ minHeight: '100vh', backgroundColor: '#f5f5f5', padding: '2rem 0' }}>
      ...
      <Container maxWidth="lg">
        ...
        >
          ...
          >
            Welcome to Workforce Management System
          </Typography>
          <Typography
            variant="h6"
            sx={{
        ...
        >
          ...
          <Typography variant="body1" sx={{ maxWidth: '800px', margin: '0 auto' }}>
            Our Workforce Management System is designed to simplify HR processes, streamline department management, and provide valuable insights into your
